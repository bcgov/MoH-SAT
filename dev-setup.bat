...
call sfdx force:apex:execute -u sat-dev -f scripts/apex/add-comm-users.apex
call sfdx force:apex:execute -u sat-dev -f scripts/apex/assign-cases-to-ecs.apex
